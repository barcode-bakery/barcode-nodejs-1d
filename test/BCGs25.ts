    ...
    describe('#maxSize', function () {
        describe('with no label', function () {
            it('should work with scale=1', function () {
                ...
                instance.parse(defaultText);
                deepEqual([(14 * defaultText.length + 8 + 0 + 7) * scale, (30) * scale], instance.getDimension(0, 0));
            });
            ...
            it('should work with scale=2 and extra positioning', function () {
                ...
                instance.setThickness(30);
                instance.parse(defaultText);
                deepEqual([(14 * defaultText.length + 8 + 0 + 7 + left) * scale, (30 + top) * scale], instance.getDimension(left, top));
            });
            ...
            it('should work with scale=2 and extra positioning and offset', function () {
                ...
                instance.parse(defaultText);
                deepEqual([(14 * defaultText.length + 8 + 0 + 7 + left + offsetX) * scale, (30 + top + offsetY) * scale], instance.getDimension(left, top));
            });
        });
        ...
        describe('with one label', function () {
            it('should work with scale=1', function () {
                ...
                deepEqual([(14 * defaultText.length + 8 + 0 + 7) * scale, (30) * scale + dimension[1]], instance.getDimension(0, 0));
            });
