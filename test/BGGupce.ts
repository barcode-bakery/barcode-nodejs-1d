    ...
    describe('#maxSize', function () {
        ...
        describe('with no label', function () {
            ...
            it('should work with scale=2 and extra positioning and offset', function () {
                ...
                instance.parse(defaultText);
                deepStrictEqual(instance.getDimension(left, top), [(7 * defaultText.length + 3 + 5 + 1 + left + offsetX) * scale, (30 + top + offsetY) * scale]);
            });
        });
        ...
        describe('with one label', function () {
            it('should work with scale=1', function () {
                ...
                // We should test Y
                strictEqual(instance.getDimension(0, 0)[0], (7 * defaultText.length + 3 + 5 + 1) * scale + getLeftLabelSize()[0] + getRightLabelSize()[0]);
            });
