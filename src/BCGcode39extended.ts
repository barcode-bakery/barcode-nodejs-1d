...
class BCGcode39extended extends BCGcode39 {
    ...
    private static readonly EXTENDED_2: number = 40;
    private static readonly EXTENDED_3: number = 41;
    private static readonly EXTENDED_4: number = 42;
    ...
    getDimension(width: number, height: number): [number, number] {
        ...
        let textlength = 13 * this.data.length;
        let startlength = 13;
        ...
        return super.get1DDimension(width, height);
    }
